...
function update_volume(widget)
   ...
   if string.find(status, "on", 1, true) then
      volume = "<span color='brown'>♫: </span> <span color='red' background='#" .. interpol_colour .. "'> " .. volume*100 .. "% </span>"
   else
      volume = "<span color='brown'>♫: </span> <span color='red' background='#" .. interpol_colour .. "'> M </span>"
   end
   widget.text = volume
end
